              ...
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden bg-[#220761]">
                ...
                <div className="p-4 text-white">
                  ...
                  <div className="flex items-center flex-wrap ">
                    ...
                    <span className="mr-3 text-white inline-flex items-center lg:ml-auto md:ml-0 ml-auto leading-none text-sm pr-3 py-1 border-r-2 border-gray-200">
                      <FaThumbsUp className="w-4 h-4 mr-1 text-white" />{item.likes}
                    </span>
                    <span className="inline-flex text-white items-center leading-none text-sm">
                      <FaComment className="w-4 h-4 mr-1 text-white" />{item.comment}
                    </span>
                  </div>
                </div>
              </div>
