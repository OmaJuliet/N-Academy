    ...
    <>
      <section className="">
        <div className="container px-5 lg:py-12 py-8 mx-auto">
          <h2 className="lg:mt-2 mt-4 mb-12 text-center text-2xl font-semibold text-white">NFT Collections</h2>
                ...
                <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden bg-[#220761]">
                  ...
                  <div className="py-6 px-2">
                    <div className="flex items-center flex-wrap justify-between">
                      ...
                      <button className="inline-flex text-white items-center px-2 py-1 border-2 border-indigo-400 rounded-lg hover:bg-white hover:text-indigo-500 hover:border-none" onClick={notify}>Buy Now</button>
                    </div>
                    <p className="tracking-widest text-xs font-medium mb-4 text-white">{item.kind}</p>
                    
                    <div className="flex items-center flex-wrap">
                      <p className="leading-relaxed inline-flex items-center mb-1 font-bold text-xl text-white">{item.eth}</p>
                      <h3 className="mr-3 inline-flex items-center lg:ml-auto md:ml-0 ml-auto font-bold text-xl text-white">{item.price}</h3>
                    </div>
                    
                    <div className="flex items-center flex-wrap">
                      <p className="inline-flex items-center md:mb-2 lg:mb-0 text-white">Floor Price
                      </p>
